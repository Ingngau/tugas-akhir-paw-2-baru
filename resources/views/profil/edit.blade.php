    ...
    <div class="container mx-auto px-4">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="text-center mb-8">
                <h1 class="text-4xl font-extrabold text-gray-800 mb-2 border-l-4 border-purple-400 pl-4 inline-block">Edit Profil Sekolah</h1>
                <p class="text-gray-600 font-light">Perbarui informasi tentang {{ $profil->nama_sekolah }}</p>
            </div>
            ...
            <div class="bg-white rounded-3xl shadow-xl overflow-hidden border-t-8 border-purple-400">
                ...
                <div class="bg-gradient-to-r from-purple-500 to-purple-600 text-white p-8">
                    <div class="flex items-center justify-center space-x-3">
                        <i class="fas fa-edit text-2xl text-purple-200"></i>
                        <h2 class="text-2xl font-bold">Form Edit Profil</h2>
                    </div>
                </div>
                                ...
                                <div class="space-y-6">
                                    <div>
                                        ...
                                        <textarea name="alamat" id="alamat" rows="3" required
                                            class="w-full border border-teal-200 rounded-xl py-3 px-4 focus:outline-none focus:ring-2 focus:ring-teal-300 focus:border-teal-300 transition duration-200 bg-white shadow-sm">{{ old('alamat', $profil->alamat) }}</textarea>
                                    </div>
                                ...
                                <div class="flex flex-col md:flex-row items-start md:items-center space-y-4 md:space-y-0 md:space-x-6">
                                    @if($profil->logo)
                                        <div class="flex-shrink-0">
                                            <img src="{{ asset('storage/' . $profil->logo) }}" alt="Logo Sekolah" class="w-24 h-24 rounded-2xl border-4 border-white shadow-lg">
                                            <p class="text-sm text-gray-500 mt-2 text-center">Logo Saat Ini</p>
                                        </div>
                                    @endif
                                    <div class="flex-1">
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                ...
                                <div class="bg-blue-50 rounded-2xl p-6 border-l-4 border-blue-400">
                                    ...
                                    <textarea name="sejarah" id="sejarah" rows="6"
                                        class="w-full border border-blue-200 rounded-xl py-3 px-4 focus:outline-none focus:ring-2 focus:ring-blue-300 focus:border-blue-300 transition duration-200 bg-white shadow-sm resize-none">{{ old('sejarah', $profil->sejarah) }}</textarea>
                                </div>
                                ...
                                <div class="space-y-6">
                                    <div class="bg-green-50 rounded-2xl p-6 border-l-4 border-green-400">
                                        ...
                                        <textarea name="visi" id="visi" rows="3" required
                                            class="w-full border border-green-200 rounded-xl py-3 px-4 focus:outline-none focus:ring-2 focus:ring-green-300 focus:border-green-300 transition duration-200 bg-white shadow-sm resize-none">{{ old('visi', $profil->visi) }}</textarea>
                                    </div>
                                    ...
                                    <div class="bg-pink-50 rounded-2xl p-6 border-l-4 border-pink-400">
                                        ...
                                        <textarea name="misi" id="misi" rows="3" required
                                            class="w-full border border-pink-200 rounded-xl py-3 px-4 focus:outline-none focus:ring-2 focus:ring-pink-300 focus:border-pink-300 transition duration-200 bg-white shadow-sm resize-none">{{ old('misi', $profil->misi) }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
